        ...
        <div className="flex items-center gap-2 ml-auto">
          {canEdit && !editMode && (
            <>
              <button
                onClick={() => setShowNewLayoutModal(true)}
                className="flex items-center space-x-1.5 px-3 py-2 bg-slate-100 dark:bg-[#1a1a1a] hover:bg-slate-200 dark:hover:bg-[#252525] text-slate-700 dark:text-gray-200 rounded-xl text-xs font-bold transition-all cursor-pointer"
              >
